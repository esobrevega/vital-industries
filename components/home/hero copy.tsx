...
export function HeroInvert() {
  return (
    <section className="relative overflow-hidden bg-[#0D2B24] pt-[7.5rem] lg:pt-[8.5rem]">
      {/* =====================================================
          HEADLINE AREA
      ====================================================== */}
      <div className="mx-auto w-full max-w-[1600px] px-6 lg:px-10 xl:px-12">
        <div className="relative min-h-[310px] lg:min-h-[360px]">
          ...
          <div className="max-w-[850px]">
            ...
            <h1 className="font-sans text-[clamp(3rem,6.5vw,6.8rem)] font-medium leading-[0.94] tracking-[-0.055em] text-white">
          ...
          >
            {/* Top Panel */}
            <div className="min-h-[180px] bg-[#F0F4EA] p-7 xl:min-h-[190px] xl:p-8">
